...
final class PhotosViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(PhotosCellView.self, forCellWithReuseIdentifier: "cell") // Вместо "cell" можно любой набор символов
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? PhotosCellView else {
